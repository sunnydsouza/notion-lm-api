# -*- coding: utf-8 -*-
"""
    Class to handle features database.

"""

__author__ = "Sunny Dsouza"
__copyright__ = "Copyright 2022, Sunny Dsouza"
__credits__ = ["Sunny Dsouza"]
